...
BEGIN
  ...
  (h_id, 'highlights', jsonb_build_object(
    ...
    'items', jsonb_build_array(
      ...
      jsonb_build_object('image', '/spa-wellness.webp', 'title', 'Großzügiger Spa-Bereich', 'text', 'Adults-Only-Bereiche, Familien-Spa, Aktiv- und Signature-Treatments.', 'link', 'Zum Wellnessbereich', 'href', '/wellness'),
