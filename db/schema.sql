...
-- 1. hotels — Master table: one row per hotel
...
-- 2. hotel_sections — Content blocks per hotel (JSONB data per section)
...
-- 3. hotel_images — Named image references per hotel
...
-- 4. hotel_faqs — FAQ entries per hotel with categories
