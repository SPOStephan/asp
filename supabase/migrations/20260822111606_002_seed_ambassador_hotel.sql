/*
# Seed: ambassador hotel & spa — Initial Content

1. Creates the first hotel record for "ambassador hotel & spa"
2. Seeds all section content (hero, welcome, wellness, culinary, discover, generations, awards, highlights, facts, newsletter, footer, wellness_page)
3. Seeds all named images currently used by the website
4. Seeds all FAQ entries (home + full categorized list)
*/
...
BEGIN
  ...
  -- hero
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'hero', jsonb_build_object(
  ...
  -- welcome
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'welcome', jsonb_build_object(
  ...
  -- highlight_strip
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'highlight_strip', jsonb_build_object(
  ...
  -- discover
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'discover', jsonb_build_object(
  ...
  -- direct_booking
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'direct_booking', jsonb_build_object(
    'eyebrow', 'Ihr Vorteil',
    'title', 'Direktbuchung',
  ...
  -- wellness
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'wellness', jsonb_build_object(
    'eyebrow', 'Zeit für',
    'title', 'Wellness',
  ...
  -- culinary
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'culinary', jsonb_build_object(
  ...
  -- generations
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'generations', jsonb_build_object(
  ...
  -- awards
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'awards', jsonb_build_object(
  ...
  -- highlights
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'highlights', jsonb_build_object(
  ...
  -- facts
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'facts', jsonb_build_object(
  ...
  -- newsletter
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'newsletter', jsonb_build_object(
  ...
  -- footer
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'footer', jsonb_build_object(
  ...
  -- navbar
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'navbar', jsonb_build_object(
    'links', jsonb_build_array(
  ...
  -- wellness_page
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'wellness_page', jsonb_build_object(
  ...
  -- faq_page
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'faq_page', jsonb_build_object(
  ...
  -- faq_home_section
  INSERT INTO hotel_sections (hotel_id, section_key, data) VALUES (h_id, 'faq_home_section', jsonb_build_object(
  ...
  -- Full categorized FAQs (show_on_home = false)
  -- Zimmer & Ausstattung
  INSERT INTO hotel_faqs (hotel_id, category, question, answer, sort_order, show_on_home) VALUES
